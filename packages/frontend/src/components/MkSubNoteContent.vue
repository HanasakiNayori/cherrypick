...
<div ref="rootEl" :class="[$style.root, { [$style.collapsed]: collapsed }]">
	...
	<div v-if="showSubNoteFooterButton">
		...
		<footer :class="$style.footer">
			...
			<button v-if="defaultStore.state.showHeartReactionButtonInNoteFooter && note.reactionAcceptance !== 'likeOnly' && note.myReaction == null" ref="heartReactButton" v-vibrate="defaultStore.state.vibrateSystem ? [30, 50, 50] : []" v-tooltip="i18n.ts.like" :class="$style.footerButton" class="_button" @click.stop="heartReact()">
